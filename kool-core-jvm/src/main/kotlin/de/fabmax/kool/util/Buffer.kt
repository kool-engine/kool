 ...
 * @author fabmax
 */
internal abstract class GenericBuffer<out B: Buffer, T>(override val capacity: Int, create: () -> B) : de.fabmax.kool.util.Buffer<T> {
    val buffer = create()
 ...
 */
internal class Uint8BufferImpl(capacity: Int) : Uint8Buffer, GenericBuffer<ByteBuffer, Byte>(capacity, {
 ...
 */
internal class Uint16BufferImpl(capacity: Int) : Uint16Buffer, GenericBuffer<ShortBuffer, Short>(capacity, {
 ...
 */
internal class Uint32BufferImpl(capacity: Int) : Uint32Buffer, GenericBuffer<IntBuffer, Int>(capacity, {
 ...
 */
internal class Float32BufferImpl(capacity: Int) : Float32Buffer, GenericBuffer<FloatBuffer, Float>(capacity, {
