...
class EditorProject(val projectData: ProjectData) {
    ...
    val entities = mutableListOf<EditorModelEntity>()
    ...
    inline fun <reified T: EditorModelComponent> getComponentsFromEntities(predicate: (EditorModelEntity) -> Boolean): List<T> {
