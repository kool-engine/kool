...
abstract class LegacyAoPipeline : AoPipeline, BaseReleasable() {
...
class ForwardAoPipeline(val scene: Scene, camera: PerspectiveCamera, drawNode: Node) : LegacyAoPipeline() {
