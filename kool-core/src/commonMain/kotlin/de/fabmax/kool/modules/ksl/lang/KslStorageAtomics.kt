...
class KslStorageAtomicOp<T: KslStorageType<R, C>, R: KslIntType, C: KslIntType>(
...
class KslStorageAtomicCompareSwap<T: KslStorageType<R, C>, R: KslIntType, C: KslIntType>(
    val storage: KslStorage<T, *>,
    val coord: KslExpression<C>,
