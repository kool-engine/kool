    ...
    KslScope(parentOp, parentScope, parentStage)
{
    ...
    fun bool2Var(initValue: KslExpression<KslBool2>? = null, name: String? = null) =
        KslVarVector(name ?: nextName("b2"), KslBool2, true).also {
            ops += KslDeclareVar(it, initValue, this)
        }
    fun bool3Var(initValue: KslExpression<KslBool3>? = null, name: String? = null) =
        KslVarVector(name ?: nextName("b3"), KslBool3, true).also {
            ops += KslDeclareVar(it, initValue, this)
        }
    fun bool4Var(initValue: KslExpression<KslBool4>? = null, name: String? = null) =
        KslVarVector(name ?: nextName("b4"), KslBool4, true).also {
            ops += KslDeclareVar(it, initValue, this)
        }
    ...
    fun uint1Array(arraySize: Int, initExpr: KslExprUint1, name: String? = null) =
        KslArrayScalar(name ?: nextName("u1Array"), KslUint1, arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }
    fun uint2Array(arraySize: Int, initExpr: KslExprUint2, name: String? = null) =
        KslArrayVector(name ?: nextName("u2Array"), KslUint2, arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }
    fun uint3Array(arraySize: Int, initExpr: KslExprUint3, name: String? = null) =
        KslArrayVector(name ?: nextName("u3Array"), KslUint3, arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }
    fun uint4Array(arraySize: Int, initExpr: KslExprUint4, name: String? = null) =
        KslArrayVector(name ?: nextName("u4Array"), KslUint4, arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }

    fun uint1Array(initExpr: KslExprUint1Array, name: String? = null) =
        KslArrayScalar(name ?: nextName("u1Array"), KslUint1, initExpr.expressionType.arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }
    fun uint2Array(initExpr: KslExprUint2Array, name: String? = null) =
        KslArrayVector(name ?: nextName("u2Array"), KslUint2, initExpr.expressionType.arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }
    fun uint3Array(initExpr: KslExprUint3Array, name: String? = null) =
        KslArrayVector(name ?: nextName("u3Array"), KslUint3, initExpr.expressionType.arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }
    fun uint4Array(initExpr: KslExprUint4Array, name: String? = null) =
        KslArrayVector(name ?: nextName("u4Array"), KslUint4, initExpr.expressionType.arraySize, true).also { definedStates += it }.also {
            ops += KslDeclareArray(it, initExpr, this)
        }
