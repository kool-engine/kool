    ...
    KslValueExpression<KslFloat2>(KslFloat2), KslVectorExpression<KslFloat2, KslFloat1>
{
    ...
    override fun collectSubExpressions(): List<KslExpression<*>> = listOf(x, y).flatMap { it.collectSubExpressions() } + this
    ...
    KslValueExpression<KslFloat3>(KslFloat3), KslVectorExpression<KslFloat3, KslFloat1>
{
    ...
    override fun collectSubExpressions(): List<KslExpression<*>> = listOf(x, y, z).flatMap { it.collectSubExpressions() } + this
    ...
    KslValueExpression<KslFloat4>(KslFloat4), KslVectorExpression<KslFloat4, KslFloat1>
{
    ...
    override fun collectSubExpressions(): List<KslExpression<*>> = listOf(x, y, z, w).flatMap { it.collectSubExpressions() } + this
...
class KslValueMat2(
    ...
    override fun collectSubExpressions(): List<KslExpression<*>> = listOf(col0, col1).flatMap { it.collectSubExpressions() } + this
...
class KslValueMat3(
    ...
    override fun collectSubExpressions(): List<KslExpression<*>> = listOf(col0, col1, col2).flatMap { it.collectSubExpressions() } + this
...
class KslValueMat4(
    ...
    override fun collectSubExpressions(): List<KslExpression<*>> = listOf(col0, col1, col2, col3).flatMap { it.collectSubExpressions() } + this
