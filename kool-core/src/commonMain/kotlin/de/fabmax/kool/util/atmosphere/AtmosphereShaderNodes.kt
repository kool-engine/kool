...
class AtmosphereNode(val opticalDepthLut: Texture2dNode, graph: ShaderGraph) : ShaderNode("atmosphereNode", graph) {
    ...
    fun printUniforms() {
        println("uDirToSun: ${uDirToSun.value}")
        println("uPlanetCenter: ${uPlanetCenter.value}")
        println("uSurfaceRadius: ${uSurfaceRadius.value}")
        println("uAtmosphereRadius: ${uAtmosphereRadius.value}")
        println("uScatteringCoeffs: ${uScatteringCoeffs.value}")
        println("uMieG: ${uMieG.value}")
        println("uMieColor: ${uMieColor.value}")
        println("uRayleighColor: ${uRayleighColor.value}")
        println("uSunColor: ${uSunColor.value}")
    }
