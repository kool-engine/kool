...
sealed interface BufferLayout {
    ...
    fun paddedSizeOf(type: GpuType, arraySize: Int): Int
    ...
    fun offsetAndSizeOf(prevPosition: Int, type: GpuType, arraySize: Int): Pair<Int, Int> {
        ...
        val size = paddedSizeOf(type, arraySize)
    ...
    data object TightlyPacked : BufferLayout {
        ...
        override fun paddedSizeOf(type: GpuType, arraySize: Int) = type.byteSize * arraySize
    ...
    data object Std140 : BufferLayout {
        ...
        override fun paddedSizeOf(type: GpuType, arraySize: Int): Int {
            return if (arraySize > 1) {
                when (type) {
                    ...
                    is GpuType.Struct -> structSize(type.byteSize) * arraySize
                    else -> 16 * arraySize
                }
            } else {
                when (type) {
