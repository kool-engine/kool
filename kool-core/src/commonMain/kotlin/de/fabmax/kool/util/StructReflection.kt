...
fun <S: Struct> S.getFloat1(member: String): Float1Member<S>? = indexOf(member).let { if (it < 0) null else getFloat1(it) }
fun <S: Struct> S.getFloat2(member: String): Float2Member<S>? = indexOf(member).let { if (it < 0) null else getFloat2(it) }
fun <S: Struct> S.getFloat3(member: String): Float3Member<S>? = indexOf(member).let { if (it < 0) null else getFloat3(it) }
fun <S: Struct> S.getFloat4(member: String): Float4Member<S>? = indexOf(member).let { if (it < 0) null else getFloat4(it) }

fun <S: Struct> S.getInt1(member: String): Int1Member<S>? = indexOf(member).let { if (it < 0) null else getInt1(it) }
fun <S: Struct> S.getInt2(member: String): Int2Member<S>? = indexOf(member).let { if (it < 0) null else getInt2(it) }
fun <S: Struct> S.getInt3(member: String): Int3Member<S>? = indexOf(member).let { if (it < 0) null else getInt3(it) }
fun <S: Struct> S.getInt4(member: String): Int4Member<S>? = indexOf(member).let { if (it < 0) null else getInt4(it) }

fun <S: Struct> S.getMat2(member: String): Mat2Member<S>? = indexOf(member).let { if (it < 0) null else getMat2(it) }
fun <S: Struct> S.getMat3(member: String): Mat3Member<S>? = indexOf(member).let { if (it < 0) null else getMat3(it) }
fun <S: Struct> S.getMat4(member: String): Mat4Member<S>? = indexOf(member).let { if (it < 0) null else getMat4(it) }

fun <S: Struct> S.getFloat1Array(member: String): Float1ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getFloat1Array(it) }
fun <S: Struct> S.getFloat2Array(member: String): Float2ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getFloat2Array(it) }
fun <S: Struct> S.getFloat3Array(member: String): Float3ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getFloat3Array(it) }
fun <S: Struct> S.getFloat4Array(member: String): Float4ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getFloat4Array(it) }

fun <S: Struct> S.getInt1Array(member: String): Int1ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getInt1Array(it) }
fun <S: Struct> S.getInt2Array(member: String): Int2ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getInt2Array(it) }
fun <S: Struct> S.getInt3Array(member: String): Int3ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getInt3Array(it) }
fun <S: Struct> S.getInt4Array(member: String): Int4ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getInt4Array(it) }

fun <S: Struct> S.getMat2Array(member: String): Mat2ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getMat2Array(it) }
fun <S: Struct> S.getMat3Array(member: String): Mat3ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getMat3Array(it) }
fun <S: Struct> S.getMat4Array(member: String): Mat4ArrayMember<S>? = indexOf(member).let { if (it < 0) null else getMat4Array(it) }

fun <S: Struct, N: Struct> S.getStruct(member: String): NestedStructMember<S, N>? = indexOf(member).let { if (it < 0) null else getStruct(it) }
fun <S: Struct, N: Struct> S.getStructArray(member: String): NestedStructArrayMember<S, N>? = indexOf(member).let { if (it < 0) null else getStructArray(it) }
