...
abstract external class WebGL2RenderingContext : WebGLRenderingContext, JsAny {
    ...
    fun getActiveUniforms(program: WebGLProgram?, uniformIndices: Uint32Array, pname: Int): Uint32Array
    fun getQueryParameter(query: WebGLQuery?, param: Int): JsAny
    fun getUniformBlockIndex(program: WebGLProgram?, uniformBlockName: String): Int
    fun getUniformIndices(program: WebGLProgram?, uniformNames: JsArray<JsString>): Uint32Array
    ...
    fun texSubImage3D(target: Int, level: Int, xoffset: Int, yoffset: Int, zoffset: Int, width: Int, height: Int, depth: Int, format: Int, type: Int, pixels: JsAny?)
...
external interface EXT_clip_control : JsAny {
...
external interface EXT_texture_filter_anisotropic : JsAny {
