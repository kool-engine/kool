...
fun PxTopLevelFunctionsFromPointer(ptr: Int, _module: JsAny = PhysXJsLoader.physXJs): PxTopLevelFunctions = js("_module.wrapPointer(ptr, _module.PxTopLevelFunctions)")
