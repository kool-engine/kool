...
fun PxActorFlags(flags: Int): PxActorFlags {
...
fun PxHitFlags(flags: Int): PxHitFlags {
    val module = PhysxJsLoader.physxJs
...
external interface PxOverlapHit
...
external interface PxRaycastHit : PxQueryHit, PxLocationHit {
    var u: Float
    var v: Float
}
...
external interface PxRigidActor : PxActor {
    ...
    fun getNbShapes(): Int
    fun getShapes(userBuffer: Array<PxShape>, bufferSize: Int, startIndex: Int): Int
}
...
fun PxRigidBodyFlags(flags: Int): PxRigidBodyFlags {
    val module = PhysxJsLoader.physxJs
...
fun PxRigidDynamicLockFlags(flags: Int): PxRigidDynamicLockFlags {
    val module = PhysxJsLoader.physxJs
...
fun PxShapeFlags(flags: Int): PxShapeFlags {
    val module = PhysxJsLoader.physxJs
...
external interface JsPxSimulationEventCallback {
    fun cbFun(count: Int)
}
fun JsPxSimulationEventCallback(): JsPxSimulationEventCallback {
    val module = PhysxJsLoader.physxJs
    return js("new module.JsPxSimulationEventCallback()")
}
