...
abstract class RigidBodyImpl : RigidActorImpl(), RigidBody {
    ...
    override fun syncSimulationData() {
        ...
        bufLinVelocity.writeIfDirty { PxRigidDynamicFromPointer(pxRigidBody.ptr).setLinearVelocity(it.toPxVec3(pxTmpVec)) }
        bufAngVelocity.writeIfDirty { PxRigidDynamicFromPointer(pxRigidBody.ptr).setAngularVelocity(it.toPxVec3(pxTmpVec)) }
