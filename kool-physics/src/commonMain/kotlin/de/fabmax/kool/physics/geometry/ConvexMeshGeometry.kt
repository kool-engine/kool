...
import de.fabmax.kool.scene.geometry.computeBounds
...
interface ConvexMeshGeometry : CollisionGeometry {
    ...
    override fun getBounds(result: BoundingBoxF) = convexMesh.convexHull.computeBounds(result)
    ...
    override fun estimateInertiaForMass(mass: Float, result: MutableVec3f): MutableVec3f {
        ...
        val bounds = convexMesh.convexHull.computeBounds()
