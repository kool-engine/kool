...
class DirectoryWatcher(val watchPaths: Set<String>) {
    ...
    val changeEvents = ArrayBlockingQueue<ChangeEvent>(100)
            ...
            while (watchKey != null) {
                for (event in watchKey.pollEvents()) {
                    ...
                    if (file != null && dir != null) {
                        ...
                        handleChangeEvent(changedFile, event)
                    }
                }
                watchKey.reset()
    ...
    private fun handleChangeEvent(chgPath: Path, chgEvent: WatchEvent<*>) {
        ...
        changeEvents.put(ChangeEvent(chgPath, eventType))
    }
